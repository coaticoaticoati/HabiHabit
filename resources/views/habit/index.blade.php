        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <form action="{{ route('habit.store') }}" method="post">
                ...
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    ...
                    <input type="date" name="achievement_date" min="1990-01-01" max="2035-12-31"
                    class="text-gray-700 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm ml-1">
                    <div class="mt-5">
