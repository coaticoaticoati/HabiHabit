...
1. アプリ開始日より前に遡って記録できる機能です。これがないと、他の習慣化アプリに移行する際に、以前の記録を引き継げないことになります。過去の成果や進捗が見直せることは、モチベーションを維持するためにも、大切な要素だと思います。
2. 習慣の継続日数などを表示する機能です。どれくらい継続できているか把握することで、より達成感を得やすくなると思います。
   
これらの課題を解決することで、ユーザーがより継続しやすくなると考え、このアプリケーションを制作しました。
...
## 苦労したところ
カレンダー上で習慣の実施状況などを表示させることに苦労しました。
習慣を達成した日にはカレンダー上の日付に丸印をつけ、本日の日付には文字の色を変えることで、ユーザーが実績を振り返りやすいデザインを目指しました。そのため、ユーザーが特定の日に習慣を達成したかどうか、そしてその日が今日なのかどうかといった条件で処理を細かく分けました。
